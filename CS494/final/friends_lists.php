...
<div class = "container">
	...
	<p>View your friend's teams below!</p>
	<?php
		if($rows = $mysqli->query("SELECT t.listid, t.pokemon, f.user FROM team_list t INNER JOIN friends f ON f.friend = '$user' WHERE pokemon IS NOT NULL ORDER BY f.user ASC")){
			if($rows->num_rows){
		...
		<p style="text-align:center;"><b>Teams Your Friends Have Made</b></p>
		<table>
		<thead>
		   <tr>
			<th>Friend</th>
